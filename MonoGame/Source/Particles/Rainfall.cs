...
{
    public class Rainfall : IParticle, IDisposable
    {
        private bool isDisposed = false;

        private ParticleEffect _particleEffect;

        public Rainfall(Texture2D texture)
        {
           _particleEffect = new ParticleEffect(autoTrigger: false)
            {
                ...
                {
                    new ParticleEmitter("Rainfall", new TextureRegion2D(texture), 400, TimeSpan.FromSeconds(2.5),
