...
namespace MonoGame.Extended.Entities.Systems
{
    public class HUDSystem: DrawSystem
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            testComponent = MonoGame.player.Get<TestComponent>();
            ...
            _spriteBatch.Begin(
                ...
                _spriteBatch.DrawString(
                    ...
                    new Vector2(0.0f, MonoGame
                    .spriteFontConsolas.LineSpacing),
                    Color.White);
                ...
                _spriteBatch.DrawString(
                    ...
                    new Vector2(0.0f, MonoGame
                    .spriteFontConsolas.LineSpacing * 2),
                    Color.White);
                ...
                _spriteBatch.DrawString(
                    ...
                    new Vector2(0.0f, MonoGame
                    .spriteFontConsolas.LineSpacing * 3),
                    Color.White);
                ...
                _spriteBatch.DrawString(
                    ...
                    new Vector2(0.0f, MonoGame
                    .spriteFontConsolas.LineSpacing * 4),
                    Color.White);
                ...
                _spriteBatch.DrawString(
                    ...
                    new Vector2(0.0f, MonoGame
                    .spriteFontConsolas.LineSpacing * 5),
                    Color.White);
                ...
                _spriteBatch.DrawString(
                    ...
                    new Vector2(0.0f, MonoGame
                    .spriteFontConsolas.LineSpacing * 6),
                    Color.White);
